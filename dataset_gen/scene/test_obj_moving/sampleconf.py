...
what_to_change = {
    ...
    "Domain.DOMAIN.resolution_max": "max_res", 
...
values = {
    ...
    ('viscosity', 'part_rad', 'part_num', 'part_random', 'ts_min', 'max_res') : [
        (-1.0, 0.8, 2, 0.1, 1, 80),
        (0.0, 1.2, 4, 1.0, 2, 80),
        (0.001, 1.2, 4, 0.1, 3, 110),
        (0.002, 1.2, 4, 1.0, 2, 80),
        (0.01, 1.2, 4, 1.0, 2, 100),
        (0.02, 1.2, 4, 1.0, 2, 80),
    ],
    ('obj_type',) : [
        ('Cylinder',),
    ...
    ('mid_loc', 'end_loc') : [
        ((0.0, 0.25, 3.2632), (0.0, 0.25, -4.3477)),
        ((0.0, 0.1185, 0.9661), (0.0, 0.1185, -4.3477)),
        ((0.0, 0.25, 3.2632), (0.0, -0.4765, -1.0137)),
    ],
    ('mid_rot', 'end_rot') : [
