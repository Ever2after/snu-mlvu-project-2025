...
what_to_change = {
    ...
    "Plane.FLOW.velocity_coord": "flow_init_v", 
...
values = {
    ...
    ('viscosity', 'part_rad', 'part_num', 'part_random', 'ts_min', 'flow_init_v') : [
        (-1.0, 0.8, 2, 0.1, 2, (15.0, 0, 0)),
        (0.0, 1.2, 4, 1.0, 2, (15.0, 0, 0)),
        (0.0001, 0.8, 2, 0.1, 2, (30.0, 0, 0)),
        (0.0002, 1.2, 4, 1.0, 2, (30.0, 0, 0)),
        (0.001, 1.2, 4, 1.0, 2, (60.0, 0, 0)),
        (0.002, 1.2, 4, 1.0, 2, (75.0, 0, -10.0)),
    ],
    ('light_angle',) : [
    ...
    ('sphere_color', 'cube_color') : [
        ...
        ((0.0282, 0.0282, 0.0282, 1.0), (0.85, 0.85, 0.85, 1.0)),
    ],
    ('water_color',) : [
        ((0.8, 0.8, 0.8, 1.0),),
