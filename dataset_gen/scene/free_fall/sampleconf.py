...
what_to_change = {
    ...
    "Cube.location": "sink_loc", 
    "Cube.scale": "sink_size", 
...
values = {
    ...
    ("flow_size", "flow_res", "sink_size", "sink_loc") : [
        ((1, 1, 1), 90, (1, 1, 1), (0, 0, 0)),
        ((1.5, 1.5, 1.5), 90, (1, 1, 2), (0, 0, -0.2)),
    ],
    ("flow_loc", ) : [
        ((0, 0, 0),),
        ((0.5, 0.5, 0),), 
